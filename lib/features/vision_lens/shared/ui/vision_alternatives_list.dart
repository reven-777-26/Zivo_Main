...
class VisionAlternativesList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final cardBg = isDark ? AppTheme.glassBackground : Colors.white;
        ...
        ...alternatives.map((alt) {
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: isDark ? AppTheme.glassBorder : Colors.black.withOpacity(0.06),
                width: 1.5,
              ),
              boxShadow: [
                BoxShadow(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(16),
                    border: Border.all(color: isDark ? AppTheme.glassBorder : Colors.transparent),
                  ),
                  child: Text(
                    alt.reason,
                    style: const TextStyle(
                ...
                Wrap(
                  ...
                  children: links.map((link) {
                    final bgColor = _getBrandBgColor(link.storeName);
                    final textColor = _getBrandTextColor(link.storeName);
