...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
          ...
          children: [
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isDark ? const Color(0xFF1C1C1E) : const Color(0xFFB2D300).withOpacity(0.15),
                  borderRadius: BorderRadius.circular(9999), // pill shape
                  border: Border.all(
                    color: isDark ? const Color(0xFF2C2C2E) : const Color(0xFFB2D300).withOpacity(0.3),
                    width: 1.0,
                  ),
                ),
                child: Row(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  color: const Color(0xFFB2D300).withOpacity(0.1),
                  border: Border.all(
                    color: const Color(0xFFB2D300).withOpacity(0.3),
                    width: 2.0,
                  ),
                ),
                child: const Center(
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xFFB2D300),
  ...
  void _showDayStreakDetailBottomSheet(BuildContext context, DateTime date, List<WorkoutSession> workouts) {
    ...
    final textColor = isDark ? Colors.white : AppTheme.textPrimary;
    final textMutedColor = isDark ? const Color(0xFF868685) : AppTheme.textSecondary;
    final accentColor = const Color(0xFFB2D300); // Neon Lime
    ...
    if (actLevel == 4) {
      ...
      badgeBg = const Color(0xFFB2D300).withOpacity(0.12);
      badgeColor = const Color(0xFFB2D300);
                              ...
                              ...workout.exercises.map<Widget>((ExerciseLog ex) {
                                ...
                                return Padding(
                                  ...
                                  child: Row(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      const Icon(Icons.check_circle_rounded, color: Color(0xFFB2D300), size: 13),
                                      const SizedBox(width: 8),
                                      Expanded(
                                        child: Text(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                  fontSize: 13,
                                  fontWeight: FontWeight.w900,
                                  color: isDark ? const Color(0xFFB2D300) : const Color(0xFF5A6B00),
                                ),
                              ),
                            ],
                          ),
          ...
          children: [
                              ...
                              child: Column(
                                children: List.generate(7, (rowIndex) {
                                  ...
                                  if (!isFuture && actLevel > 0) {
                                    ...
                                    cellColor = const Color(0xFFB2D300).withOpacity(opacity);
                                  } else if (isFuture) {
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    _buildLegendCell(const Color(0xFFB2D300).withOpacity(0.2), isDark),
                    _buildLegendCell(const Color(0xFFB2D300).withOpacity(0.45), isDark),
                    _buildLegendCell(const Color(0xFFB2D300).withOpacity(0.7), isDark),
                    _buildLegendCell(const Color(0xFFB2D300), isDark),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: isDark ? const Color(0xFF272C15) : const Color(0xFFB2D300).withOpacity(0.3),
                  width: 1.0,
                ),
              ),
              child: Row(
